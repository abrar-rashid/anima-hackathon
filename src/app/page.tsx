...
/**
 * The landing page is the worklist, not a scripted patient. `assembleWorklist`
 * already degrades to a stale or empty envelope rather than throwing, so the
 * catch here only covers an unexpected failure in assembly itself; even then
 * the shell paints and says so instead of going blank.
 */
